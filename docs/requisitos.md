...
### 2.1.2. Registro de medidas antropométricas
...
### 2.1.3. Cálculo automático de z-score
...
### 2.1.4. Classificação visual do estado nutricional
...
### 2.1.5. Histórico de acompanhamento da criança
...
### 2.1.6. Gráfico de curva de crescimento da OMS
...
### 2.1.8. Interface simples e rápida para uso em campo
...
### 2.1.9. Alta legibilidade em ambientes externos
...
### 2.1.10. Proteção de dados e privacidade
...
### 2.1.11. Exportação de relatório resumido
